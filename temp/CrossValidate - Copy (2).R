...
bestaccData = NULL;
write.csv(bestaccData,outFile);
{
bestaccData = rbind(bestaccData, c("Jackknife Classification",bestPerf$maxFeatureCount, bestPerf$svmC, bestPerf$acc, bestPerf$sens, bestPerf$spec, bestPerf$mcc));
